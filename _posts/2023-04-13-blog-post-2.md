...
Method 1: $2.79\times 10^{-5}$ secs vs. Method 2: $2.25\times 10^{-5}$ secs. In this mini example, Method 2 has a faster average runnign time and fewer lines of code than Method 1. Moreover, if we replace 5 with a much larger number, Method 2 will run even faster compared to Method 1. 
